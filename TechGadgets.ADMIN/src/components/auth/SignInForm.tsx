...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('✅ Validación exitosa, procediendo con el login...');
    ...
    <div className="flex flex-col flex-1">
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          ...
          {generalError && (
            <div className="mb-4 p-3 text-sm text-red-700 bg-red-100 border border-red-200 rounded-md dark:bg-red-900/20 dark:text-red-400 dark:border-red-800">
              {generalError}
            </div>
          )}
